...
if (current_user_can('manage_options')) {
	...
	if ($_GET['catname']) {
		...
		$lekhook_users = get_users($args);

		if (!empty($lekhook_users)) {
			...
			echo '<br /><br /><span class="alert alert-success">Also remember to update "Auto Create These Boards for New Users" theme option <a href="' . admin_url('themes.php?page=options-framework') . '" target="_blank">here</a>.</span><br />';
