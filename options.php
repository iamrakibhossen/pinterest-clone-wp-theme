...
if (isset($_GET['settings-updated']) && of_get_option('default_avatar') != '') {
	...
	if (!is_wp_error($image)) {
		...
		update_option('lekhook_avatar_96', $upload_dir['baseurl'] . '/avatar-96x96.' . $ext);
		$image->resize(48, 48, true);
		$image->save($upload_dir['basedir'] . '/avatar-48x48.' . $ext);
		update_option('lekhook_avatar_48', $upload_dir['baseurl'] . '/avatar-48x48.' . $ext);
	}
} else if (isset($_GET['settings-updated']) && of_get_option('default_avatar') == '') {
	$ext = explode('.', get_option('lekhook_avatar_48'));
	$ext = array_pop($ext);
	$upload_dir = wp_upload_dir();

	delete_option('lekhook_avatar_48');
	delete_option('lekhook_avatar_96');
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Show Frontpage\'s Posts Based On', 'options_framework_theme'),
		'id' => 'frontpage_popularity',
		'std' => 'showall',
		'type' => 'radio',
		'options' => array('likes' => __('Most Likes', 'options_framework_theme'), 'reposts' => __('Most Reposts', 'options_framework_theme'), 'comments' => __('Most Comments', 'options_framework_theme'), 'random' => __('Random', 'options_framework_theme'), 'showall' => __('Show All', 'options_framework_theme')));

	$options[] = array(
		'desc' => __(' Over Last X Days (only for Most Likes/Reposts/Comments)', 'options_framework_theme'),
	...
	$options[] = array(
		'name' => __('Show Popular Page\'s Posts Based On', 'options_framework_theme'),
		'id' => 'popularity',
		'std' => 'showall',
		'type' => 'radio',
		'options' => array('likes' => __('Most Likes', 'options_framework_theme'), 'reposts' => __('Most Reposts', 'options_framework_theme'), 'comments' => __('Most Comments', 'options_framework_theme'), 'showall' => __('Show All', 'options_framework_theme')));
	...
	$options[] = array(
		'desc' => __('When your site is new, select "Show All" so that the frontpage & popular page will not be blank. As the posts get more likes, reposts or comments, select as appropriate.', 'options_framework_theme'),
		'type' => 'info');
	...
	$options[] = array(
		'name' => __('Post It Button Image', 'options_framework_theme'),
		'desc' => __('Leave blank to use text for Post It Button at <a href="' . home_url('/post/') . '">Add > Post</a>.', 'options_framework_theme'),
		'id' => 'postit_button',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Show Reposts', 'options_framework_theme'),
		'desc' => __('If disabled, reposts are hidden from the front, categories and tags page', 'options_framework_theme'),
		'id' => 'show_reposts',
		'std' => 'enable',
		'type' => 'radio',
		'options' => array('enable' => __('Enable', 'options_framework_theme'), 'disable' => __('Disable', 'options_framework_theme')));
	...
	$options[] = array(
		...
		'desc' => __('For use in add/edit posts forms', 'options_framework_theme'),
		'id' => 'form_title_desc',
		'std' => 'single',
		'type' => 'radio',
	...
	$options[] = array(
		...
		'desc' => __('If enabled, users can add tags to posts.', 'options_framework_theme'),
		'id' => 'posttags',
		'std' => 'disable',
		'type' => 'radio',
		'options' => array('enable' => __('Enable', 'options_framework_theme'), 'disable' => __('Disable', 'options_framework_theme')));
	...
	$options[] = array(
		...
		'desc' => __('If enabled, users can add source url to posts.', 'options_framework_theme'),
		'id' => 'source_input',
		'std' => 'disable',
		'type' => 'radio',
		'options' => array('enable' => __('Enable', 'options_framework_theme'), 'disable' => __('Disable', 'options_framework_theme')));
	...
	$options[] = array(
		...
		'desc' => __('Default is $. Leave blank to disable price input and price tag shown in top left corner of the post.', 'options_framework_theme'),
		'id' => 'price_currency',
		'std' => '$',
		'type' => 'text');
	...
	*/
	...
	$options[] = array(
		'desc' => __('When a user delete a post or a board, the posts are marked as prune for deletion later. Depending on your server load, you can adjust how often the system delete these posts.', 'options_framework_theme'),
		'type' => 'info');
	...
	$options[] = array(
		...
		'desc' => __('If you purchase the optional Browser Extension Pack, enter the ID to activate (<a href="http://ericulous.com/2013/09/18/browser-addonsextensions-pack-for-lekhook-pro/" target="_blank">how to get ID</a>).', 'options_framework_theme'),
	...
	*/
	...
	$options[] = array(
		...
		<h2>Adding Posts</h2>
		<p>All users should add posts from the frontend (top right corner)  > Add > <a href="' . home_url('/post/') . '" target="_blank">Post</a>. Notes when adding posts from backend e.g WP-Admin > Posts > Add New</p>
		<ol>
		...
		<hr style="border:none;border-top:1px solid #ccc;color" />
		<h2>Permissions</h2>
		<p>You can change the Settings > General > <a href="' . admin_url('options-general.php') . '" target="_blank">New User Default Role</a> depending on your needs. If unsure, leave it as "Author" which best matched Postterest.com system. The permissions for each role are as below.</p>
		<p><strong>Administrator</strong>
		- Everything</p>
		<p><strong>Editor</strong>
		- All of Author
		- Access WP-Admin
		- Publish "Pending Review" Post (backend)
		- Edit/Delete Others Post (frontend)
		- Edit/Delete Others Board (frontend)
		- Edit Others Profile (frontend)
		</p>
		<p><strong>Author</strong>
		- All of Contributor
		- Add Post (Post Status: Published)
		- Repost
		</p>
		<p><strong>Contributor</strong>
		- All of Subscriber
		- Add Post (Post Status: Pending Review)
		</p>
		...
		<ol>
		<li>
		WP-Admin > Pages > All Pages<br />Do not change the permalink for these pages (Board Settings, Everything, Following, Login, Lost Your Password, Notifications, Posts Settings, Popular, Register, Settings, Source, Top Users)
		</li>
		<li>
