				...
				<div class="col-sm-12">
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class('post-wrapper'); ?>>
						...
						<div class="post-blog-top">
							...
							<div class="pull-right"><a href="#navigation"><?php comments_number(__('0 Comments', 'lekhook'), __('1 Comment', 'lekhook'), __('% Comments', 'lekhook'));?></a><?php edit_post_link(__('Edit', 'lekhook'), ' | '); ?></div>
						</div>
